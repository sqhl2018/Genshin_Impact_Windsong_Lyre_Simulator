...
extern uint8_t res_clef_base_png[];extern uint32_t res_clef_base_png_size;
extern uint8_t res_clef_tensor_png[];extern uint32_t res_clef_tensor_png_size;
extern uint8_t res_clef_png[];extern uint32_t res_clef_png_size;
...
extern uint8_t res_re_down_png[];extern uint32_t res_re_down_png_size;
extern uint8_t res_fa_down_png[];extern uint32_t res_fa_down_png_size;
extern uint8_t res_mi_down_png[];extern uint32_t res_mi_down_png_size;
extern uint8_t res_la_down_png[];extern uint32_t res_la_down_png_size;
extern uint8_t res_do_down_png[];extern uint32_t res_do_down_png_size;
extern uint8_t res_so_down_png[];extern uint32_t res_so_down_png_size;
extern uint8_t res_ti_down_png[];extern uint32_t res_ti_down_png_size;
extern uint8_t res_g_png[];extern uint32_t res_g_png_size;
extern uint8_t res_icon_png[];extern uint32_t res_icon_png_size;
